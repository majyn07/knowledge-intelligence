...
export function toTicket(raw: unknown): Ticket {
  ...
  return normalizeTicket({
    ...
    sintoma: row.sintoma,
    causa: row.causa,
    tipoDeProblema: row.tipo_problema,
    fechamento: row.fechamento,
    quemAbriu: row.quem_abriu,
    protecaoTecnologica: row.protecao_tecnologica,
...
export function fromTicket(ticket: Ticket): Record<string, unknown> {
  return {
    ...
    causa: ticket.causa,
    tipo_problema: ticket.tipoDeProblema,
    fechamento: ticket.fechamento,
    quem_abriu: ticket.quemAbriu,
    protecao_tecnologica: ticket.protecaoTecnologica,
