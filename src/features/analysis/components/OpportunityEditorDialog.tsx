    ...
    <Dialog open={Boolean(opportunity)} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Ajuste a proposta antes de registrá-la como uma decisão humana.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="opportunity-justification">Justificativa</Label>
            <Textarea
              id="opportunity-justification"
              value={justification}
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={!title.trim() || !description.trim() || !justification.trim()}
          >
            Salvar decisão
          </Button>
        </DialogFooter>
