  ...
  return (
    <div className="w-full space-y-12">
      <PageHeader
        ...
        description="O que foi descoberto, o que precisa de revisão, o que está evoluindo."
        ...
        */
        activeProject === null ? (
          <BrandEmptyState
            ...
            description="Traga o acervo do portal pela Biblioteca ou registre o primeiro atendimento."
          />
        ) : (
          <BrandEmptyState
